...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   |4.33 msec per loop|4.07 msec per loop|62.2 msec per loop     |
| `check_palindrome_2`   |3.04 msec per loop|3.18 msec per loop|3.21 msec per loop
